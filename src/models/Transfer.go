...
type Transfer struct {
	...
	Account_origin         Account   `gorm:"ForeignKey:Account_origin_id;constraint:OnUpdate:CASCADE,OnDelete:RESTRICT"`
	Account_destination_id string    `json:"Account_destination_id" valid:"notnull"`
	Account_destination    Account   `gorm:"ForeignKey:Account_destination_id;constraint:OnUpdate:CASCADE,OnDelete:RESTRICT"`
